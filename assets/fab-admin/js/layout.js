...
import 'bootstrap';
import 'fastclick';
import fabAdminTemplate from "./moduli/template";
...
$(function () {
    ...
    //richiama le funzioni di template

    fabAdminTemplate.layout();
    fabAdminTemplate.pushMenu();
    fabAdminTemplate.tree();
    fabAdminTemplate.controlSidebar();
    fabAdminTemplate.boxWidget();
    fabAdminTemplate.todoList();
    fabAdminTemplate.directChat();
